    ...
    return (
        ...
        <main className={styles.page}>    
            <section className={styles.screen}>
                ...
                <p className={styles.contacts_item}>ИНН / КПП: 4706053435 / 470601001</p>
                <p className={styles.contacts_item}>ОГРН: 1224700019114</p>
                <p className={styles.contacts_item}>АДРЕС: 192236, РОССИЯ СЗФО, Г САНКТ-ПЕТЕРБУРГ, УЛ СОФИЙСКАЯ 14, ОФИС 915</p>
                <p className={styles.contacts_item}>ТЕЛЕФОН: 8(800)201-00-73</p>
                <p className={styles.contacts_item}>РЕЖИМ РАБОТЫ: ПН-ПТ, 10-18</p>
            </section>
