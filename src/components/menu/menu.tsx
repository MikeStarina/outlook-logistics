    ...
    return(
        <div className={styles.menu}>
            ...
            <div className={styles.contacts_wrapper}>
                ...
                <a href='https://t.me/OUTLOOK_LOGISTICS' className={styles.contacts_item}>Telegram</a>
                <a href='https://api.whatsapp.com/send?phone=79223671541' className={styles.contacts_item}>Whatsapp</a>
            </div>
        </div>
    )
}
